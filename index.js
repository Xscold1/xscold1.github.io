...
const experiences = {
  gcg: `
    <div class="expContainer">
      <div class="expContainerHeader">
        <h1>Junior Software Engineer</h1>
      </div>
      <div class="expContainerBody">
    ...
    <div class="expContainer">
      ...
      <div class="expContainerBody">
        <div class="keyRespCard">
          ...
          <ul>
            <li>
              Collaborated in the development of a full-stack web application using <b>Node</b>, <b>React JS</b>, <b>Bootstrap</b>, and <b>MySQL</b> to improve data accuracy and usability
            </li>
            <li>
      ...
      <div class="expContainerBody">
        <div class="keyRespCard">
          ...
          <ul>
            ...
            <li>
              Automated processes for Project Tracking for an Engineering firm, Scheduler for a school, and BudgetTracker in Mobile
            </li>
          </ul>
        </div>
      </div>
